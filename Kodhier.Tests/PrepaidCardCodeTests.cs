...
namespace Kodhier.Tests
{
    public class PrepaidCardCodeTests
    {
        ...
        public async Task User_use_code()
        {
            ...
            var manageCtrl = new ManageController(null, null, null, null, null, _context, new Mock<IMemoryCache>().Object, null) { ControllerContext = new ControllerContext { HttpContext = httpContext } };
